...
//                break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_type = new String[]{"others","others","others", "others", "hls","hls"};
        video_url = new String[]{"https://emerald.rev.lavenderhosted.com/s5e12.mp4",
                ...
                "https://imbe.fruithosted.net/dl/n/Qfx81379DzL7cM5B/pbblksnqaasbomms/hNZsdLMlRC12NI6a4VVoW2tQ4_5OQUmU5NkVVVBmIaXlD28VMPRgoEWCJuCYG9QXzTG3qp7pCAr_QS1czfKvxx2UxP-9ih0_WPe9mKti4aljJ27Vyv0fC9iPv04y6LT4ORM4FDah2wOPbP222gXznkYuPypYjMXBNI7GlUBu8nBlyS0PtyATGR1SCoOO6bUBhHsG1G95nIA6-315X8A3GrwrC8DR8CmV3RQKXZwKlHEFJoSZDzu_YyQXif6K3riHsnjABPiUshOBo6kSDjpU5cJ2j-RCtqRggkT1PsK_xi-j1DNLhB7HRnJsbONNmUP1mqJintS6qav-5eM7CslDBLN7m6i4X80b33GIDQ5bxl0ifMcagOkloolsA2OghkVSutvFOYbl1FTjOqhF1hPghMlN6BmDjhJyN87bZJjvNZg/tangled_2010_eng.mp4",
    ...
    private void execute() {
        ...
        subView.setPlayer(playerControl);
        if(currentTrackIndex==0) subView.setSubSource(R.raw.sub1,MediaPlayer.MEDIA_MIMETYPE_TEXT_SUBRIP);
        if(currentTrackIndex==1) subView.setSubSource(R.raw.sub2,MediaPlayer.MEDIA_MIMETYPE_TEXT_SUBRIP);
        if(currentTrackIndex==2) subView.setSubSource(R.raw.sub5,MediaPlayer.MEDIA_MIMETYPE_TEXT_SUBRIP);
        if(currentTrackIndex==3) subView.setSubSource(R.raw.sub3,MediaPlayer.MEDIA_MIMETYPE_TEXT_SUBRIP);
