...
public class HpLib_HlsHpLibRendererBuilder implements HpLib_RendererBuilder {
    ...
    public HpLib_HlsHpLibRendererBuilder(DynVideoPlayer player, String userAgent, String video_url) {
        this.context = player;
        this.userAgent = userAgent;
        this.url = video_url;
    }
    @Override
    public void buildRenderers(DynVideoPlayer player) {
    ...
    private static final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<HlsPlaylist> {
        ...
        private final String userAgent;
        private final String url;
        private final DynVideoPlayer player;
        private final ManifestFetcher<HlsPlaylist> playlistFetcher;
        private boolean canceled;
        public AsyncRendererBuilder(Context context, String userAgent, String url, DynVideoPlayer player) {
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                    MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, DynVideoPlayer.TYPE_VIDEO);
