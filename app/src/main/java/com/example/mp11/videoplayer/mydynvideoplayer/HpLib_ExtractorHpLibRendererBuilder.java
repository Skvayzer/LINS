...
public class HpLib_ExtractorHpLibRendererBuilder implements HpLib_RendererBuilder {
    ...
    public void buildRenderers(DynVideoPlayer player) {
        ...
        // Invoke the callback.
        TrackRenderer[] renderers = new TrackRenderer[DynVideoPlayer.RENDERER_COUNT];
        renderers[DynVideoPlayer.TYPE_VIDEO] = videoRenderer;
        renderers[DynVideoPlayer.TYPE_AUDIO] = audioRenderer;
